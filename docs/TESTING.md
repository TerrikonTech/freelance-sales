...
Он отдельно проверяет CMS/stack fit, честную оговорку при несовпадении стека,
запрет неподтверждённого опыта, точную ссылку и фактическую деталь кейса,
ритм/абзацы/обращения, коммерческие числа и отсутствие системной заглушки старта.
